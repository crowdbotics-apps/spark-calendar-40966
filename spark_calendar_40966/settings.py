"""
Django settings for spark_calendar_40966 project.
...
ROOT_URLCONF = 'spark_calendar_40966.urls'
...
WSGI_APPLICATION = 'spark_calendar_40966.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spark_calendar_40966 API",
    "DESCRIPTION": "API documentation for spark_calendar_40966 App",
    "VERSION": "v1",
}
